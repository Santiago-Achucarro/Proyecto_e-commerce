...
bton1.addEventListener("click",(e)=> {
    ...
    if(cantidad <= 10){
        carrito.innerHTML = `<li>${cantidad} ${biz1.tortas} ${valor} total </li> `

    }else{
        alert(`alcanzaste el limite por compra de la unidad ${biz1.tortas}`)
    }
})
...
bton2.addEventListener("click",(e)=> {
    ...
    if(cantidad2 <= 10){
        carrito.innerHTML = `<li>${cantidad2} ${biz2.tortas} ${valor2} total </li> `
    }else{
        alert(`alcanzaste el limite por compra de la unidad ${biz2.tortas}` )
    }
})
...
bton3.addEventListener("click",(e)=> {
    ...
    cantidades3(e);
    if(cantidad3 <= 10){
        carrito.innerHTML = `<li>${cantidad3} ${biz3.tortas} ${valor3} total </li> `
    }else{
        alert(`alcanzaste el limite por compra de la unidad ${biz3.tortas} `)
    }
})
